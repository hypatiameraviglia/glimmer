...
# Tests of read_data
    ...
    def test_dataset_is_string(self):
        dataset = read_in_lit.read_data(self.directory).dataset
        self.assertEqual(type(dataset), type(""))

    def test_ks_in_array(self):
        k = read_in_lit.read_data(self.directory).k
    ...
    def test_wavels_in_array(self):
        wavel = read_in_lit.read_data(self.directory).wavel
...
#Tests of get_error
    ...
    def test_dk_in_array(self):
        dk = read_in_lit.get_error(read_in_lit.read_data(self.directory)).dk
